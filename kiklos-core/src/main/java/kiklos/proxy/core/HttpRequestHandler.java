...
public class HttpRequestHandler extends ChannelInboundHandlerAdapter {
	...
	private final static boolean DB_LOGER_ENABLED = Boolean.valueOf(System.getProperty("DB_LOGER_ENABLED", "true"));
    private final static boolean FULL_URI_LOG_ENABLED = Boolean.valueOf(System.getProperty("FULL_URI_LOG_ENABLED", "false"));
	...
	private Map<String, String> composeDbEntryMap(final HttpRequest req, final String remoteHost) {
		...
		try {
			...
			m.put("value", FULL_URI_LOG_ENABLED ? uri : "");
